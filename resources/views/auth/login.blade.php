                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password"
                                       class="form-control border-0 @error('password') is-invalid @enderror" name="password" placeholder="Tu contraseña"
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" class="btn btn-primary btn-block" dusk="login-btn">
                                    {{ __('Login') }}
                                </button>
